...
class BannerCourse(Course):
    ...
    class Meta:
        verbose_name = '轮播课程'
        verbose_name_plural = verbose_name
        # proxy只是为了为Course设置一个代理模型(即为基于Course的另外一张数据表,和Course表可以一样,但是改动它不会影响Course表的内容)
        # 详情参考:https://docs.djangoproject.com/zh-hans/2.1/topics/db/models/#proxy-models
        proxy = True
